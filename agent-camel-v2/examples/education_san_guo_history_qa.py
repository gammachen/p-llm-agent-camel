...
示例：{"question": "三国时期指的是哪三个国家？", "answer": "魏、蜀、吴"}
...
{"question": "哪场战役奠定了三国鼎立的基础？", "answer": "赤壁之战"}
{"question": "“既生瑜，何生亮”这句感叹出自谁之口？", "answer": "周瑜"}
{"question": "蜀汉的建立者是谁？他在哪里称帝？", "answer": "刘备，成都"}
{"question": "三国时期最后被哪个政权统一？", "answer": "西晋"}
{"question": "《三国志》的作者是谁？它属于哪一类史书？", "answer": "陈寿，纪传体断代史"}"""
        )
...
4. 只给出你认为的正确答案"""
    ...
    def play_round(self, round_num: int) -> Dict[str, Any]:
        ...
        # AI助手出题
        print("🤖 AI助手正在出题...")
        question_msg = BaseMessage.make_user_message("系统", "请出1个三国历史知识题目，必须输出JSON格式")
